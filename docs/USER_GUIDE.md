...
### Metrics Overview & AI Insights

The lower part of the Team Detail page adds **AI-assisted summaries and recommendations**.

#### Metrics Overview (Context for AI)

Above the AI section you will see a **Metrics Overview** grid highlighting key inputs the AI uses:
- Test Coverage, Defect Density, Automation Coverage
- Lead Time, MTTR, Sprint Commitment Rate
- Change Failure Rate, Build Time

Each card is color-coded (green / amber / red) with a short explanation of why the value is good or needs attention. This helps you validate the data before reading AI suggestions.

#### Team AI Insights

Below the Metrics Overview is the **AI Insights** section:
- Shows **Strongpoints**, **Areas of Improvement**, and a multi-item **Action Plan** for the team.
- If AI is enabled for the team, you will see:
  - A small label: `Powered by: AI` or `Rule-based analysis`.
  - A disclaimer when AI is used: _"Generated by AI. May contain inaccuracies — please verify before acting."_

If AI is disabled at team level, a message appears instead:
- "AI suggestions are disabled for this team. Enable AI in admin settings to get personalized recommendations."

The suggestions combine data from all 22 KPIs into a narrative view of team strengths and risks.
