    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="px-8 py-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-500 mt-1">Optimize your deployment pipeline with data-driven insights</p>
            </div>
            
            <div className="flex items-center space-x-6">
              <div className="text-center">
                <p className="text-sm text-gray-500">Total Duration</p>
                <div className="text-3xl font-bold text-gray-900">{Math.floor(totalDuration / 60)}m</div>
              </div>
              <div className="text-center">
      ...
      <div className="px-8 py-8">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
          <h2 className="text-xl font-bold text-gray-900 mb-6">Pipeline Flow</h2>
        ...
        {/* Duration Breakdown */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Duration Breakdown</h2>
          <div className="h-64">
            ...
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <div className="space-y-2">
                  <h4 className="font-semibold text-red-900">Optimization Suggestions:</h4>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-bold text-gray-900">Stage Details</h2>
          {stages.map((stage, index) => (
...
const PipelineStageNode: React.FC<PipelineStageNodeProps> = ({ stage }) => {
  ...
  return (
    <div className={`relative bg-white rounded-lg border-2 ${getBottleneckColor()} p-4 w-32 text-center shadow-md hover:shadow-lg transition-shadow`}>
      <div className={`absolute -top-2 -right-2 w-6 h-6 rounded-full ${getStatusColor()} border-2 border-white`}></div>
      <div className="text-xs font-semibold text-gray-900 mb-2 truncate">{stage.name}</div>
      <div className="text-lg font-bold text-gray-900">{Math.floor(stage.duration / 60)}m</div>
      <div className="text-xs text-gray-500">{stage.success_rate}%</div>
    </div>
  );
};
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-4">
            <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
              stage.success_rate >= 95 ? 'bg-green-100' : stage.success_rate >= 85 ? 'bg-yellow-100' : 'bg-red-100'
            }`}>
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Stage {stageIndex + 1} of {totalStages}</p>
            </div>
          </div>

          <div className="flex items-center space-x-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900">{Math.floor(stage.duration / 60)}m {stage.duration % 60}s</div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-4">
          <div className="bg-blue-50 rounded-lg p-3">
            ...
            <div className="text-xl font-bold text-blue-900">{stage.resource_usage.cpu}%</div>
          </div>
          ...
          <div className="bg-purple-50 rounded-lg p-3">
            ...
            <div className="text-xl font-bold text-purple-900">{stage.resource_usage.memory}%</div>
          </div>
          ...
          <div className="bg-green-50 rounded-lg p-3">
            ...
            <div className="text-xl font-bold text-green-900">${stage.resource_usage.cost}</div>
          </div>
        </div>
        ...
        {stage.bottleneck_score > 50 && (
          <div className={`rounded-lg p-3 mb-4 ${
            stage.bottleneck_score > 70 ? 'bg-red-50 border border-red-200' : 'bg-yellow-50 border border-yellow-200'
          }`}>
            <div className="flex items-center justify-between">
              <div>
                <span className={`text-sm font-semibold ${stage.bottleneck_score > 70 ? 'text-red-900' : 'text-yellow-900'}`}>
                  ⚠️ Bottleneck Score: {stage.bottleneck_score.toFixed(1)}
                </span>
                <p className={`text-xs ${stage.bottleneck_score > 70 ? 'text-red-700' : 'text-yellow-700'}`}>
        ...
        {expanded && (
          <div className="mt-4 pt-4 border-t border-gray-200 space-y-3">
            <div className="bg-blue-50 rounded-lg p-4">
              <h4 className="text-sm font-semibold text-blue-900 mb-3">💡 Optimization Recommendations</h4>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <h5 className="text-sm font-semibold text-gray-700 mb-2">Potential Time Savings</h5>
                <p className="text-2xl font-bold text-green-600">-{Math.floor(stage.duration * 0.3 / 60)}m</p>
                <p className="text-xs text-gray-500">With recommended optimizations</p>
              </div>
              <div>
                <h5 className="text-sm font-semibold text-gray-700 mb-2">Potential Cost Savings</h5>
                <p className="text-2xl font-bold text-green-600">-${(stage.resource_usage.cost * 0.25).toFixed(2)}</p>
