        ...
        <div className="px-8 py-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-500 mt-1">{team.department} • Detailed Quality Metrics</p>
            </div>
            
            <div className="flex items-center space-x-6">
              <div className="text-right">
                <p className="text-sm text-gray-500">Team QA Score</p>
                <div className="text-4xl font-bold text-gray-900">{team.qaScore}/100</div>
              </div>
              <div className="relative w-20 h-20">
                <svg className="w-full h-full transform -rotate-90">
                  <circle cx="40" cy="40" r="35" stroke="#e5e7eb" strokeWidth="6" fill="transparent" />
                  <circle 
                    cx="40" 
                    cy="40" 
                    r="35" 
