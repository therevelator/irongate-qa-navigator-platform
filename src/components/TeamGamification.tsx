    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Gamification Disabled</h2>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-8 py-8">
        {/* Podium */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">🏆 Top 3 Teams 🏆</h2>
          <div className="flex items-end justify-center space-x-8">
            ...
            {leaderboard[1] && (
              <div className="flex flex-col items-center">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 w-64 text-center border-4 border-gray-300">
                  <div className="text-4xl font-bold text-gray-600 mb-2">2nd</div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">{leaderboard[1].team_name}</h3>
            ...
            {leaderboard[0] && (
              <div className="flex flex-col items-center -mt-8">
                ...
                <div className="bg-white rounded-xl shadow-2xl p-8 w-72 text-center border-4 border-yellow-400">
                  <div className="text-5xl font-bold text-yellow-600 mb-2">1st</div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">{leaderboard[0].team_name}</h3>
            ...
            {leaderboard[2] && (
              <div className="flex flex-col items-center">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 w-64 text-center border-4 border-orange-400">
                  <div className="text-4xl font-bold text-orange-600 mb-2">3rd</div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">{leaderboard[2].team_name}</h3>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Full Leaderboard</h2>
...
const LeaderboardRow: React.FC<LeaderboardRowProps> = ({ team, rank, isSelected, onSelect }) => {
  const getRankColor = (rank: number) => {
    if (rank === 1) return 'bg-yellow-100 border-yellow-300 text-yellow-900';
    if (rank === 2) return 'bg-gray-100 border-gray-300 text-gray-900';
    if (rank === 3) return 'bg-orange-100 border-orange-300 text-orange-900';
        ...
        <div className="mt-4 pt-4 border-t border-gray-300">
          ...
          <div className="space-y-2">
            {team.achievements.map(achievement => (
              <div key={achievement.id} className="bg-white/50 rounded-lg p-3 flex items-start space-x-3">
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      <div className="flex items-start space-x-4">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-500">{count} teams qualified</span>
